...
In \cref{chap:graph_data}, we have introduced a Bayesian method to estimate uncertainty estimation on graph data. In this chapter, we now focus on uncertainty estimation on time events.
