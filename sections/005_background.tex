...
% Make more detailed description of method types
% - Ensembles
% - Monte Carlo Dropout
%% - Markov Chain Monte Carlo (incl. Gibbs, Metropolis-Hasting, Hamiltonian)
...
\paragraph*{Evidential.}

\paragraph*{Calibration.} Temperature scaling

\paragraph*{Conformal Predictions.}

\paragraph*{Energy-based models.}

\paragraph*{Density-based models.} Hidden uncertianty, PostNet
