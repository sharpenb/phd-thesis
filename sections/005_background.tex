...
We recall the Bayes formula since it is a core concept in many uncertainty estimation approaches.
...
We provide a collection of benchmarks which cover the different tasks in \cref{tab:overview_evaluation}. Beyond these metrics, note that Bayesian methods have been also used in other tasks like  model pruning, model selection, or hyper-parameter tuning \citep{bayesian-networks,daxberger2021laplace}.
...
\begin{center}
    \textbf{Are model predictions robust to data drift?}
\end{center}
