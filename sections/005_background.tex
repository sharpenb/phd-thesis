...
\begin{table*}[ht]
    ...
    \midrule
    \midrule
    Correct/wrong pred. detection & \cite{Hendrycks2016, shifts-dataset} & \emph{Trust} \\
    OOD detection & \cite{yang2022openood, cao2020ood, kirchheim2022pytorch, Hendrycks2016} & \emph{Safety}\\
    Robustness to dataset shifts & \cite{wilds, neuhold201mapillary, shifts-dataset, benchmarking-corruptions, taori2020shift, dataset-shift, croce2021robustbench} & \emph{Maintenance} \\
    Uncertainty calibration & \cite{dataset-shift, chung2021uncertainty,nado2021uncertainty} & \emph{Fairness}\\
    \bottomrule
    \end{tabular}%
    }
    \end{center}
