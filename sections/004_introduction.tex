...
In all these applications, AI have shown to be applicable with various data types (e.g. images, tabular, text, graphs) and at various scales from very small (e.g. molecules) to very large systems (e.g. social networks).
...
\begin{itemize}
    ...
    \item Accurate and efficient \emph{models} for uncertainty estimation.
