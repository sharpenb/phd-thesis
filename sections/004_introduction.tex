...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[t]{0.245\columnwidth}
        ...
        \label{fig:fairness}
   \end{subfigure}%
    \caption{Overview of the practical reasons for uncertainty estimation.}
	% \vspace{-.5cm}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[t]{0.245 \columnwidth}
        \centering
        $\vcenter{\hbox{\includegraphics[width=0.9 \textwidth]{resources/tabular-cropped.pdf}}}$
         \caption{Non-deterministic world at large scale}
         \label{fig:nondeterministic_large_scale}
    \end{subfigure}%
    \begin{subfigure}[t]{0.245\columnwidth}
        \centering
        $\vcenter{\hbox{\includegraphics[width=0.9 \textwidth]{resources/tabular-cropped.pdf}}}$
        \caption{Non-deterministic world at small scale}
        \label{fig:nondeterministic_small_scale}
    \end{subfigure}%
    \begin{subfigure}[t]{0.245 \columnwidth}
        \centering
        $\vcenter{\hbox{\includegraphics[width=0.9 \textwidth]{resources/tabular-cropped.pdf}}}$
         \caption{Partially observable world}
         \label{fig:partially_observable}
    \end{subfigure}%
    \caption{Overview of the theoretical reasons for uncertainty estimation.}
	% \vspace{-.5cm}
\end{figure}
