...
After previously studying uncertainty estimation on independent data in \cref{part:independent_data}, we now focus on uncertainty estimation for non-independent data (e.g. graph data, sequential data). To this end, we start in this chapter by considering the task of node classification on graphs.
