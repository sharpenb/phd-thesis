\begin{table}
    ...
    \vspace{5mm}
    \caption{Accuracy, Calibration, and OOD-detection results of \GPNacro{} on the CoraML dataset with latent dimensions in $[6, 10, 16]$.}
...
\begin{table}
    ...
    \vspace{5mm}
    \caption{Accuracy, Calibration, and OOD-detection results of \GPNacro{} on the CoraML dataset with the number of radial layers in $[6, 10, 16]$.}
...
\begin{table}
    ...
    \vspace{5mm}
    \caption{Accuracy, Calibration, and OOD-detection results of \GPNacro{} on the CoraML dataset  with a teleport probability $\tau$ in $[0.05, 0.1, 0.2]$.}
...
\begin{table}
    ...
    \vspace{5mm}
    \caption{Accuracy, Calibration, and OOD-detection results of \GPNacro{} on the CoraML dataset with a budget that scales exponentially w.r.t. the latent dimension and a budget that scales exponentially w.r.t. the latent dimension and the number of classes.}
    \label{tab:gs-budget}
\end{table}